      ...
      <div className="mx-auto max-w-4xl rounded-2xl bg-content1 p-6 shadow-md">
        ...
        <article className="prose dark:prose-invert max-w-none prose-a:text-primary">
          ...
          <p>
            ...
            pessoais que você fornece ao preencher formulários neste site ou em
            anúncios.
          </p>
          ...
          <p>
            ...
            <br /> Contato:{" "}
            <a href="mailto:seu@email">gustavobreasy@gmail.com</a>
          </p>
          ...
          <p>
            Usamos os dados para entrar em contato, qualificar leads e oferecer
            nossos serviços. Podemos usar dados para análises internas e
            melhoria de campanhas.
          </p>

          <h2>5. Direitos</h2>
          <p>
            Você pode solicitar acesso, correção, exclusão ou portabilidade dos
            seus dados, e retirar o consentimento a qualquer momento pelo e-mail
            indicado acima.
          </p>
        </article>
      </div>
